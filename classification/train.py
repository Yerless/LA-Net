...
parser.add_argument('--log_dir', default='log/LA-NEt/32', help='Log dir [default: log]')
    ...
    with tf.Graph().as_default():
        with tf.device('/gpu:'+str(GPU_INDEX)):
            ...
            with tf.variable_scope('sampler'):
                sample_points = SAMPLER_MODEL.get_points1(pointclouds_pl, is_training_sampler_pl, NUM_OUT_POINTS, bn_decay=bn_decay)

            # Get model and loss 
            pred, end_points = MODEL.get_model(sample_points, is_training_pl, bn_decay=bn_decay)
        ...
        sess.run(init, {is_training_sampler_pl: True, is_training_pl: True})
